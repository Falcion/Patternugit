...
Because [an open source license](https://opensource.org/definition-annotated/) requires that anyone can use, modify, and share your project for nearly any purpose, projects themselves tend to be free of charge. If the project cost money to use, anyone could legally make a copy and use the free version instead.
...
For more inspiration, try using \@dguo’s [“Make a README”](https://www.makeareadme.com/) guide or \@PurpleBooth’s [README template](https://gist.github.com/PurpleBooth/109311bb0361f32d87a2) to write a complete README.
