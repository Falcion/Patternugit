...
A common misconception about contributing to open source is that you need to contribute code. In fact, it's often the other parts of a project that are [most neglected or overlooked](https://github.com/blog/2195-the-shape-of-open-source). You'll do the project a *huge* favor by offering to pitch in with these types of contributions!
...
* **Discussion forums or mailing lists:** Some projects may use these channels for conversational topics (for example, *"How do I..."* or *"What do you think about..."* instead of bug reports or feature requests). Others use the issue tracker for all conversations. A good example of this would be [CHAOSS' weekly Newsletter](https://chaoss.community/news/)
