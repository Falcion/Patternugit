...
While you can define your project roles any way you’d like, [consider using broader definitions](https://opensource.guide/how-to-contribute/#what-it-means-to-contribute) to encourage more forms of contribution. You can use leadership roles to formally recognize people who have made outstanding contributions to your project, regardless of their technical skill.
